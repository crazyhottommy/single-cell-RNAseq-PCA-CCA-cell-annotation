...
In `Seurat`(Tim Stuart et al 2019), the other way is to use Canonical Correlation Analysis (CCA) for data integration and label transferand we will explore it today!
